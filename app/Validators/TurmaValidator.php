...
class TurmaValidator extends LaravelValidator
{
    ...
    protected $attributes = [
        ...
        'serie_id' => 'Série',
        'procedimento_avaliacao_id' => 'Procedimento de Avaliação',
        'turno_id' => 'Turno',
    ...
    protected $rules = [
        ValidatorInterface::RULE_CREATE => [
            'codigo' => 'required|max:50|unique:turmas,codigo',
            ...
            'procedimento_avaliacao_id' => 'required|numeric',
        ...
        ValidatorInterface::RULE_UPDATE => [
            'codigo' => 'required|max:50|unique:turmas,codigo,:id',
            'nome' => 'required|max:100',
            'escola_id' => 'required|numeric',
            'tipo_atendimento_id' => 'required|numeric',
            'calendario_id' => 'required|numeric',
