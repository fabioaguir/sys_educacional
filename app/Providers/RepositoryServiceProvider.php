...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(
            \SerEducacional\Repositories\HistoricoRepository::class,
            \SerEducacional\Repositories\HistoricoRepositoryEloquent::class);
        ...
        $this->app->bind(
            \SerEducacional\Repositories\ConcelhoPedagogicoRepository::class,
            \SerEducacional\Repositories\ConcelhoPedagogicoRepositoryEloquent::class);
