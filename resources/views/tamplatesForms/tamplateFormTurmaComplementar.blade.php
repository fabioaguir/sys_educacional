<div class="block-header">
    <h2>Cadastro de Turmas Complementares</h2>
</div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <div class=" fg-line">
                            <label for="quantidade_atividade_id">Quantidade Atividade *</label>
                            <div class="select">
                                {!! Form::select("quantidade_atividade_id", ["" => "Selecione uma quantidade"] + $loadFields['quantidadeatividade']->toArray(), null, array('class'=> 'form-control')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <a class="btn btn-primary btn-sm m-t-10" href="{{ route('turmaComplementar.index') }}">Voltar</a>
                </div>
            </div>
        </div>
    </div>
...
@section('javascript')
    ...
    {{--Regras de validação--}}
    <script type="text/javascript" src="{{ asset('/dist/js/validacao/turmaComplementar.js')  }}"></script>
@endsection