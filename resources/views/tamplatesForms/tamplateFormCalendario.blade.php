                    ...
                    <div class="form-group col-md-4">
                        <div class="fg-line">
                            <div class="fg-line">
                                ...
                                {!! Form::text('data_inicial', Session::getOldInput('data_inicial'), array('class' => 'form-control input-sm', 'placeholder' => 'Data inicial')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <div class="fg-line">
                            <div class="fg-line">
                                ...
                                {!! Form::text('data_final', Session::getOldInput('data_final'), array('class' => 'form-control input-sm', 'placeholder' => 'Data final')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <div class="fg-line">
                            <div class="fg-line">
                                ...
                                {!! Form::text('data_resultado_final', Session::getOldInput('data_resultado_final'), array('class' => 'form-control input-sm', 'placeholder' => 'Data de resultado final')) !!}
                            </div>
                        </div>
                    </div>
                </div>
