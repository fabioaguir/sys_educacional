        ...
        <div class="container">
            ...
            <div class="card material-table">
                <div class="card-header">
                    ...
                    @permission('cargo.store')
                    <!-- Botão novo -->
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="text-right">
                                <a class="btn btn-primary btn-sm m-t-10", href="{{ route('cargo.create') }}">Novo Cargo</a>
                            </div>
                        </div>
                    </div>
                    <!-- Botão novo -->
                ...
                <div class="table-responsive">
                    <table id="cargo-grid" class="table table-hover">
                            <thead>
                            <tr>
                                <th>Nome</th>
                                <th>Codigo</th>
...
@section('javascript')
    <script type="text/javascript">
        var table = $('#cargo-grid').DataTable({
            processing: true,
            serverSide: true,
